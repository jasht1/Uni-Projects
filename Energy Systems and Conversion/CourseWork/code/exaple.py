...
from CoolProp.Plots import PropertyPlot as PropertyPlot #StateContainer
from CoolProp.Plots import SimpleCompressionCycle as SimpleCompressionCycle
...
for i in range(size(TT)[1]):
 pp = PropertyPlot("R32", "PH", unit_system="KSI")
 ...
 cycle = SimpleCompressionCycle("R32", "PH", unit_system="KSI")
