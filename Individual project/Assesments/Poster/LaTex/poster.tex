...
%the logo (the logo on the right)
{
  ...
  \includesvg[height=0.95\headerheight]{images/SDG_TARGET_34.svg}
}
...
\begin{posterbox}[name=lists,column=0,below=abstract]{Lists}
Itemize
\begin{itemize}
  \item item 1
    \begin{itemize}
...
This loss of function is due to physical changes at the cellular level induced by cytokine TGF-$\beta$ 1 associated with an observable change in cytoskeleton stiffness [@hillsCE2012-TGFvModulatesCelltocell]. 
...
\begin{posterbox}[name=figures,column=1,below=method,above=bottom]{Figures and Tables}
...
\begin{posterbox}[name=problems,column=2,below=method]{Known Problems}
  \begin{itemize}
