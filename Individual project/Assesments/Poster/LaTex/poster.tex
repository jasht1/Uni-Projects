...
%the logo (the logo on the right)
{
  ...
  \includegraphics[height=0.75\headerheight]{images/UoL_logo.png}
}
...
\begin{posterbox}[name=intro,column=0,row=0]{Abstract}
\begin{justify}
...
\begin{center}
  \includegraphics[height=0.90\headerheight]{images/emc2}
