...
\begin{minipage}[t]{0.26\linewidth}
  \includesvg[width=\linewidth]{images/Classification_Threashhold_byDistributionModel.svg}
  \captionof{figure}{Classification Curves}
\end{minipage}


\end{posterbox}

\begin{posterbox}[name=discuss,column=1,below=results,above=bottom]{Discussion}
  \begin{center}
  \begin{description}
